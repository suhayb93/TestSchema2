CREATE OR REPLACE FORCE NONEDITIONABLE VIEW mdsys.my_sdo_index_metadata (sdo_index_owner,sdo_index_type,sdo_level,sdo_numtiles,sdo_maxlevel,sdo_commit_interval,sdo_index_table,sdo_index_name,sdo_index_primary,sdo_tsname,sdo_column_name,sdo_rtree_height,sdo_rtree_num_nodes,sdo_rtree_dimensionality,sdo_rtree_fanout,sdo_rtree_root,sdo_rtree_seq_name,sdo_fixed_meta,sdo_tablespace,sdo_initial_extent,sdo_next_extent,sdo_pctincrease,sdo_min_extents,sdo_max_extents,sdo_index_dims,sdo_layer_gtype,sdo_rtree_pctfree,sdo_index_partition,sdo_partitioned,sdo_rtree_quality,sdo_index_version,sdo_index_geodetic,sdo_index_status,sdo_nl_index_table,sdo_dml_batch_size,sdo_rtree_ent_xpnd,sdo_root_mbr) AS
